...
Import Modrinth modpacks as new server groups. Select the modpack, choose a version, and the dashboard creates the group and downloads everything.
...
```toml title="config/nimbus.toml"
[api]
cors_origins = ["https://dashboard.nimbuspowered.org", "https://your-custom-domain.com"]
```
