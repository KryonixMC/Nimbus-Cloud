...
- **Web Dashboard** (ALPHA) — Browser-based management UI at [dashboard.nimbuspowered.org](https://dashboard.nimbuspowered.org). Service overview, real-time console, plugin management, stress testing, and more — all from your browser.
...
| **nimbus-cli** | Remote CLI that connects to the controller's REST API + WebSocket. Same commands, tab completion, and formatting as the local console. Includes session tracking. |
...
Want a visual interface? Try the [Web Dashboard](/docs/guide/dashboard) (ALPHA) at [dashboard.nimbuspowered.org](https://dashboard.nimbuspowered.org).
