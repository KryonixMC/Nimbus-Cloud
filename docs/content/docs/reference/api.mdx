...
Endpoints for importing Modrinth modpacks. Used by both the console `import` command and the [Web Dashboard](/docs/guide/dashboard).

### POST /api/modpacks/import

Import a Modrinth modpack as a new server group.
...
{
  "success": true,
  "message": "Modpack imported as group 'Modded'",
  "group": "Modded"
}
```
...
List supported modpack platforms.
